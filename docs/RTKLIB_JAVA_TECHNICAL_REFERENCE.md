...
以下常量用于级联模糊度固定和BDS码偏差改正：

| 常量 | 值(Hz) | 说明 |
|------|---------|------|
| `FREQE1` | 1.57542E9 | Galileo E1（同GPS L1） |
| `FREQE5a` | 1.17645E9 | Galileo E5a（同GPS L5） |
| `FREQB1I` | 1.561098E9 | BDS B1I |
| `FREQB2I` | 1.20714E9 | BDS B2I |
| `FREQB3I` | 1.26852E9 | BDS B3I |
...
*文档版本：v2.5*
*最后更新：2026-08-20*
*变更：实现SSR相位偏差改正（RtklibCommon.corrPhaseBiasSsr），在RtkProcessor/PppProcessor/PostPosProcessor中rtkpos/pppos前调用*
*维护者：RTKLIB Java移植团队*